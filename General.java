...
class General extends Programme{
	public General(){
	...
	public String[] getContentArray() {
		...
		try {
			Scanner sInFile = new Scanner(new File(Directory + "General.txt"));
	...
	public String FilePath(){
		return Directory + "General.txt";
	}
	
}; // Closing General Class